...
if __name__ == "__main__":
    ...
    for image_name in os.listdir("./inputs_old/ground_truth/"):
        ...
        image_output_original = cv2.imread("./results/RealESRGAN_x4plus.pth/"+image_real_name+image_ext+"_lr_out"+".jpg")
        psnr1, ssim1, l1_1, l2_1 = evaluate(image_gt, image_output_original)
        image_output_new = cv2.imread("./results/net_g_10000.pth/"+image_real_name+image_ext+"_lr_out"+".jpg")
        psnr2, ssim2, l1_2, l2_2 = evaluate(image_gt, image_output_new)
        image_lr = cv2.imread("./inputs/"+image_real_name+image_ext+"_lr.jpg")
